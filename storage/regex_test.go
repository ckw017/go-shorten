...
func TestRegexLoad(t *testing.T) {
	r, err := NewRegexFromList(map[string]string{
		...
		`(pull|pr)/(\d+)`: "https://github.com/ckw017/go-shorten/pull/$2",
	})
	if err != nil {
	...
	testTable := []struct {
		...
		{in: "pull/1234", expected: "https://github.com/ckw017/go-shorten/pull/1234"},
		{in: "pr/1234", expected: "https://github.com/ckw017/go-shorten/pull/1234"},
